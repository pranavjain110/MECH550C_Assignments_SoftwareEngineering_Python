...
def intInput(string):
    while True:
        try:
            ...
            input("Press Enter to input the value again")
    return(value)
...
def floatInput(string):
    while True:
        try:
            ...
            print("Error: That is not a valid float number")
            input("Press Enter to input the value again")
    return(value)
...
def multiplyMatrices():
    def listOfTuples(row,col):
        ...
        for i in range(row*col):
            re = floatInput("Enter the Real part: ")
            im = floatInput("Enter the Complex part: ")
            matList.append((re,im))
        return matList

    # def inputList():
    #     row=intInput("Enter the Number of Rows of the matrix 1:")
    #     col=intInput("Enter the Number of Columns of the matrix 1:")
    #     listOfElements = listOfTuples(row1,col1)


    row1=intInput("Enter the Number of Rows of the matrix 1:")
    col1=intInput("Enter the Number of Columns of the matrix 1:")
    listA = listOfTuples(row1,col1)
    print("List A is:\n")
    print(listA)
    row2=intInput("Enter the Number of Rows of the matrix 1:")
    col2=intInput("Enter the Number of Columns of the matrix 1:")
    listB = listOfTuples(row2,col2)
...
while True:
    try:
        ...
        switch = intInput("Please enter the option number: ")
        if switch==4: 
            break
        ...
        if switch==1:
            multiplyMatrices()
        if switch==2:
            print("Chimney Chutiya !!!!!!!!!!")
        if switch==3:
            print("Sameer Chutiya !!!!!!!!!!")
